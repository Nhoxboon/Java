...
public class GUI_updateNV extends JFrame {
    ...
    public GUI_updateNV() {
        ...
        btnFind.addActionListener(new FindButton(txtMaNV, txtHoTen, txtDiachi, txtLuong));
        btnUpdate.addActionListener(new UpdateButton(txtMaNV, txtHoTen, txtDiachi, txtLuong));
        btnInsert.addActionListener(new InsertButton(txtMaNV, txtHoTen, txtDiachi, txtLuong));
        btnDelete.addActionListener(new DeleteButton(txtMaNV));
        setVisible(true);
    }
}
